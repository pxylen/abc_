...
############## loon
#悦动族获取TOKEN
http-response https:\/\/yuedongzu\.yichengw\.cn\/* script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/yuedongzu.js, requires-body=1,max-size=0, tag=悦动族获取TOKEN

############## surge
#悦动族获取TOKEN
悦动族获取TOKEN = type=http-response,pattern=https:\/\/yuedongzu\.yichengw\.cn\/*,script-path=https://cdn.jsdelivr.net/gh/ziye888/JavaScript@main/Task/yuedongzu.js
