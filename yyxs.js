...
2,点击书架随便看一本书，等待一分钟左右获取时长数据，注意必须是要在阅读小说里面的数据才算成功，如果没进阅读里面提示获取数据成功是无效的。
3,继续等待右上角金币转圈完毕，获取计时奖励数据
4,禁用阅友小说header，开启阅友小说body
5,点击福利界面，点击看视频奖励，观看一个视频获取数据
6,继续点击福利界面幸运大转盘，转一次获取抽奖数据

TG电报群: https://t.me/hahaha8028

阅友小说的阅读福利和连续阅读福利暂时没加，跑完脚本自己去领取吧，下次再加入吧
阅友小说默认的计时奖励是一个金币，脚本强制更改为50金币了。。。
boxjs地址 :  
