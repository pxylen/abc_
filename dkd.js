...
let url = {
    ...
    const result = JSON.parse(data)
        ...
        console.log('广告视频回执:成功🌝 '+result.award)
}
...
let url = {
    ...
    const result = JSON.parse(data)
        if(result.status_code == 200){
        console.log('视频宝箱回执:成功🌝 '+result.award)
}
if(result.status_code == 10020){
...
let url = {
    ...
    const result = JSON.parse(data)
        if(result.status_code == 200){
        console.log('视频宝箱翻倍回执:成功🌝 '+result.award)
}
if(result.status_code == 10020){
...
let url = {
    ...
    const result = JSON.parse(data)
        if(result.status_code == 200){
        console.log('转盘抽奖回执:成功🌝 '+result.award)
}
if(result.status_code == 10020){
...
let url = {
    ...
    const result = JSON.parse(data)
        if(result.status_code == 200){
        console.log('分享任务回执:成功🌝 '+result.award)
}
if(result.status_code == 10020){
  ...
  let url = {
      ...
      const result = JSON.parse(data)
          if(result.status_code == 200){
          console.log('小说任务回执:成功🌝 '+result.award)
  }
  if(result.status_code == 10020){
...
let url = {
    ...
    const result = JSON.parse(data)
        if(result.status_code == 200){
        console.log('提现回执:成功🌝 '+result.award)
}
if(result.status_code == 10020){
...
let url = {
    ...
    const result = JSON.parse(data)
        if(result.status_code == 200){
        console.log('签到回执:成功🌝 '+result.sign_award)
}
if(result.status_code == 10020){
